                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        @foreach($authors as $author)
                            <div class="bg-gradient-to-tl from-blue-500 to-indigo-500 border border-blue-600 shadow-xl rounded-2xl p-6 text-white transform transition duration-300 hover:scale-105 hover:shadow-2xl">
                                <h3 class="text-xl font-semibold mb-3">{{ $author->name }}</h3>
