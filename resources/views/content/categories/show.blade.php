                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        ...
                        <div class="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                            <p class="mb-2"><span class="font-bold">Name:</span> {{ $category->name }}</p>
                        </div>
                    </div>

                    @if($category->contents && $category->contents->count() > 0)
                        <div class="mt-8">
                            <h3 class="text-xl font-semibold mb-4">Content in {{ $category->name }}</h3>
                    ...
                    @else
                        <div class="mt-8">
                            <div class="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-400 dark:border-yellow-600 p-4">
                                <p class="text-yellow-700 dark:text-yellow-400">No content associated with this category yet.</p>
                            </div>
                        </div>
                    @endif
